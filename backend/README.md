...
## Project Structure
    ...
    ├── testapiautosetting_115896  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115896`
...
2. Clone this repo and `cd testapiautosetting_115896`
